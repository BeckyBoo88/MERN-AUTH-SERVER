...
router.post('/register', async (req, res) => {
    try {
        ...
        console.log(err)
        res.status(500).jston({ msg: 'internal server error' })
    }
})

// POST /user/login -- validate login creditals
router.post('/login', async (req, res) => {
    try {
        ...
        // check the user's password from the db against what is the req.body
